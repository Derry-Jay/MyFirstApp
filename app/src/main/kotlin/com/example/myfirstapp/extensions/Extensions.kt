...
import com.example.myfirstapp.data.mailRegex
import com.example.myfirstapp.data.runTime
import com.example.myfirstapp.data.today1
import com.example.myfirstapp.data.today2
import com.example.myfirstapp.utils.Api
...
val String.uriBuilder: Uri.Builder?
    get() {
...
val String?.retrofitInstance: Retrofit
    get() {
        return Retrofit.Builder().baseUrl(trimmed)
